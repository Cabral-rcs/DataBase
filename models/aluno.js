// Aqui temos os métodos para manipular os dados do aluno no banco de dados - CRUD
// Onde o controller se comunica com o model (através de funções) para manipular os dados
